...
##### Libraries ####
list.of.packages = c('Matrix','Rcpp','tibble')
...
usersArticlesTimeDiffMatrix = matrix(data = 1,nrow = 10,ncol = 8,dimnames = (list(rownames(usersArticlesMatrix),colnames(usersArticlesMatrix))))
